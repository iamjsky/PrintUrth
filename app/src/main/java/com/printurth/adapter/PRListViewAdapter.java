...
import com.printurth.MainActivity;
...
public class PRListViewAdapter extends RecyclerView.Adapter<PRListViewAdapter.Holder> {
 //   private LayoutInflater inflate;
  ...
  //  MainActivity mainActivity;
    ...
    public PRListViewAdapter(Context context, List<RollingBannerModel> list){
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_prlist_item, parent, false);
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        if(list.get(position).getIsfin() == 1) {
            holder.isFin.setVisibility(View.VISIBLE);
            Glide.with(context).load(R.drawable.icn_setcheck).into(holder.isFin);
        } else {
            holder.isFin.setVisibility(View.INVISIBLE);
        }
        ...
        holder.go_detail_item.setOnClickListener(view -> {
            Intent intent = new Intent(context, PRDetailActivity.class);
            intent.putExtra("data_id", list.get(position).getId());
            intent.putExtra("data_thumbnail", list.get(position).getThumbImgName());
            intent.putExtra("data_title", list.get(position).getTitle());
    ...
    public class Holder extends RecyclerView.ViewHolder{
        ...
        public Holder(View view){
            ...
            go_detail_item = (ImageView) view.findViewById(R.id.go_detail_item);
