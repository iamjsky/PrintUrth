...
public class ModelSurfaceView extends GLSurfaceView {
    ...
    public void setViewTop() {
     //   Log.e("[DEBUG]", "tclick!");
        renderer.setTopAngle();
        requestRender();
    }
    public void setViewRight() {
     //   Log.e("[DEBUG]", "rclick!");
        renderer.setRightAngle();
        requestRender();
    }
    public void setViewFront() {
      //  Log.e("[DEBUG]", "fclick!");
        renderer.setFrontAngle();
        requestRender();
    }

    public void setViewBottom() {
       // Log.e("[DEBUG]", "tclick!");
        renderer.setBottomAngle();
        requestRender();
    }
    public void setViewLeft() {
      //  Log.e("[DEBUG]", "rclick!");
        renderer.setLeftAngle();
        requestRender();
    }
    public void setViewBack() {
       // Log.e("[DEBUG]", "fclick!");
        renderer.setBackAngle();
        requestRender();
    }
    @Override
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (event.getPointerCount() == 1) {
                    ...
                    previousX = x;
                    previousY = y;
                  //  Log.e("~!", "dy,dx : " + Util.pxToDp(dy) + " /// " + Util.pxToDp(dx) );
