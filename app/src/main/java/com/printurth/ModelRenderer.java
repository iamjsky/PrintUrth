...
public class ModelRenderer implements GLSurfaceView.Renderer {
    ...
    public void setBottomAngle() {
       // Matrix.setLookAtM(viewMatrix, 0, 0, 0, 0, 0f, 0f, 0f, 0.0f, 0.0f, -30.0f);
        rotateAngleX = 90.0f;
        rotateAngleY = 0.0f;
    ...
    public void setLeftAngle() {
       // Matrix.setLookAtM(viewMatrix, 0, 0, 0, 0, 0f, 0f, 0f, -30.0f, 0.0f, 0.0f);
        rotateAngleX = 0.0f;
        rotateAngleY = 90.0f;
    ...
    public void setRightAngle() {
      //  Matrix.setLookAtM(viewMatrix, 0, 0, 0, translateZ, 6, 2, 1, 6, 1, 5);
        rotateAngleX = 0.0f;
        rotateAngleY = -90.0f;

        updateViewMatrix();
    }
    public void setFrontAngle() {
      //  Matrix.setLookAtM(viewMatrix, 0, 0, 0, translateZ, 0, 1, 2, 0, 2, 3);
//        Matrix.rotateM(viewMatrix, 0, -15, 1f, 0f, 0f);
//        Matrix.rotateM(viewMatrix, 0, 15, 0f, 1f, 0f);
...
//        Matrix.setLookAtM(viewMatrix, 0, 0, 0, 0, 0f, 0f, 0f, 0f, -30.0f, 0.0f);
        rotateAngleX = 0.0f;
        rotateAngleY = -180.0f;
...
//Log.e("~!~!", "x : " + rotateAngleX + "      y : " + rotateAngleY);
        updateViewMatrix();
    ...
    //    Log.e("[DEBUG]", "translateX : " + translateX + " translateY : " + translateY + " translateZ : " + translateZ + " rotateAngleX : " + rotateAngleX  + " rotateAngleY : " + rotateAngleY );
    }
